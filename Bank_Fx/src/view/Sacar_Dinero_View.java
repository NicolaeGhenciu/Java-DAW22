...
public class Sacar_Dinero_View extends GridPane {
	...
	public Sacar_Dinero_View(String ibanx) throws SQLException, FileNotFoundException {
		...
		this.encabezado = new Label("Retirar Dinero €");
		this.cantidadActual = new Label("Saldo Actual: " + db.getAccount(ibanx).getSaldo() + " €");
		this.texto = new Label("Cantidad a Retirar: ");
