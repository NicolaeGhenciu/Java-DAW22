...
public class Multiplicaciones_View extends GridPane {
	...
	public Multiplicaciones_View(MathO o) {
		...
		String diseño = ("-fx-font-family: 'Impact'; -fx-text-fill: #F85858; -fx-border- width: 10px; -fx-background-color: WHITE; -fx-font-size: 30px;");
		...
		tituloOperacion = new Label("MULTIPLICACIONES");
		contador = new Label(o.getContador());
		mensaje = new Label("");

		int n1 = o.genNumeroUno(1);
		int n2 = o.genNumeroDos(1);

		System.out.println(o.getResultadoMultiplicaciones());

		resultado = new Label("");
		operacion = new Label(" " + n1 + " * " + n2 + " ");
