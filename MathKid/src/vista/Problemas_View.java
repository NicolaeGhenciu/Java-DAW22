...
public class Problemas_View extends GridPane {
	...
	public Problemas_View(MathO o) {
		...
		String diseñoNegro2 = ("-fx-text-fill: #000000; -fx-background-color: WHITE; -fx-font-size: 18px; -fx-font-family: 'Impact';");
		Font font = Font.font("Verdana", FontWeight.EXTRA_BOLD, 15);

		tituloOperacion = new Label("PROBLEMAS");
		contador = new Label(o.getContador());
		mensaje = new Label("");

		resultado = new Label("");
		operacion = new Label(o.getProblema(o.getIntentos() - 1));
		...
		operacion.setStyle(diseñoNegro2);
